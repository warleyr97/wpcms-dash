  ...
  const theme = createTheme(
    {
      ...
      palette: {
        type: mode,
        primary: { main: "#689B4C" },
        textPrimary: mode === "light" ? "#689B4C" : "#FFFFFF",
        borderPrimary: mode === "light" ? "#689B4C" : "#FFFFFF",
        dark: { main: mode === "light" ? "#333333" : "#F3F3F3" },
        light: { main: mode === "light" ? "#F3F3F3" : "#333333" },
        tabHeaderBackground: mode === "light" ? "#EEE" : "#333",
        optionsBackground: mode === "light" ? "#fafafa" : "#333",
        options: mode === "light" ? "#fafafa" : "#666",
        fontecor: mode === "light" ? "#689B4C" : "#fff",
        ...
        barraSuperior:
          mode === "light"
            ? "linear-gradient(to right, #689B4C, #33621A, #193808)"
            : "#666",
